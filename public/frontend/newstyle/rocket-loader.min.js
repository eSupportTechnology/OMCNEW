!function () {
    ...
    var A = "http://www.w3.org/2000/svg",
        ...
        M = function () {
            var t = window;
            return t.__rocketLoaderLoadProgressSimulator || Object.defineProperty(t, "__rocketLoaderLoadProgressSimulator", { value: new j }),
                ...
                t.prototype.run = function () {
                    for (var t = this, e = this;
                        ...
                        var n = function () {
                            ...
                            return o ? r.external && r.executable && !r.async ?
                                (u(o, function () {
                                    t.finalizeActivation(r), t.run();
                                }), { value: void 0 }) : void e.finalizeActivation(r) :
    ...
    !function () {
        ...
        if (t) {
            var n = b(t);
            n ? (o(t), g(n), M.updateInlineHandlers(), n.bailout ? w(n.nonce) : (S(), x(n.nonce))) :
