;(function ($, window) {
    ...
    function init() {
        ...
        exzoom_nav.append("<div id='exzoom_nav_inner' class='exzoom_nav_inner'></div>");
        ...
        exzoom_nav.css({
            "height": navHeightWithBorder + 4 + "px",
...
//     setTimeout(function(){
//         var exzoom_nav_w = $('#exzoom_nav').width();
//         var exzoom_nav_innerw = $('#exzoom_nav_inner').width();
//         console.log($('#exzoom_nav'))
//         console.log($('#exzoom_nav_inner'));
//         console.log(exzoom_nav_innerw, exzoom_nav_w);
//         if(exzoom_nav_innerw >exzoom_nav_w){
//             $('.exzoom_btn').show();
//         }
//     }, 10000)
// });