                    ...
                    <div class="tab-content terms-tab" id="v-pills-tabContent">
                            ...
                            <div id="accordion" role="tablist">
                                ...
                                <div class="content-section">
                                    ...
                                    <ol>
                                        ...
                                        <li class="title-other">Are my online transactions safe?
                                            <ol style="list-style-type: lower-alpha;">
                                                <li>Yes. We utilize the latest in digital encryption &amp; web technology to
                                                    ...
                                                    safe when
                                                    you shop at myomc.lk. You can read our <a href="policy.html">Privacy
                                        ...
                                        <li class="title-other">What is Pickup ?
                                            <ol style="list-style-type: lower-alpha;">
                                                <li>If you don’t want to wait for your order to be delivered to your home,
                                                    you can now pick it up yourself from one of our OMC Elite Showrooms.
                                        ...
                                        <li class="title-other">What is the myomc.lk return/refund policy?
                                            <ol style="list-style-type: lower-alpha;">
                        ...
                        <div class="tab-pane fade  show active " id="v-pills-four" role="tabpanel"
                            ...
                            <p class="monial-graph">We guarantee that all products sold by OMC PLC are in good quality
                                ...
                                usage, subject to the following terms and conditions. OMC PLC agrees to repair the
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\OMC\OMCNEW\resources\views/frontend/warranty.blade.php ENDPATH**/ ?>