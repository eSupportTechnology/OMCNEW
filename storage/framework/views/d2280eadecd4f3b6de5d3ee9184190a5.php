...
<body>
                                        ...
                                        <a href="javascript:void(0)" class="mobile-cart-link">
                                            <div class="mobile-cart-wrapper">
                                                ...
                                                <span class="mobile-cart-count"
                                                    id="cart-count-1"><?php echo e($cartCount ?? 0); ?></span>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="mobile-icon-item mobile-wishlist wishlist-popup">
                                        <a href="javascript:void(0)" class="mobile-wishlist-link">
                                            <div class="mobile-cart-wrapper">
                                                ...
                                                <span class="mobile-cart-count" id="wishlist-count-mobile"><?php echo e($wishlistCount ?? 0); ?></span>
                                            </div>
                                        </a>
                                    </div>
                                        ...
                                        <div class="des-cart pos-relative cart-popup me-3">
                                            ...
                                            <a href="javascript:void(0)" class="d-flex">
                                                ...
                                                <div class="dt-icon-div">
                                                    ...
                                                    <img src=" <?php echo e(asset('frontend/newstyle/assets/images/cart-new.png')); ?>"
                                                        class="cart-img">
                                                </div>
                                            ...
                                            <a href="javascript:void(0)" class="d-flex align-items-center">
                                                ...
                                                <div class="dt-icon-div">
                                                    <span id="wishlist-count"
                                                        class="w-16 h-16 text-xs text-white flex-center rounded-circle bg-main-two-600 position-absolute top-n6 ">
                                                        <?php echo e($wishlistCount ?? 0); ?>


                                                    </span>
                                                    <img src="<?php echo e(asset('frontend/newstyle/assets/images/wishlist-icon-color.png')); ?>" class="wishlist-img">
                                                </div>
    ...
    </header><?php /**PATH C:\xampp\htdocs\OMCNEW\resources\views/frontend/navbar-new.blade.php ENDPATH**/ ?>