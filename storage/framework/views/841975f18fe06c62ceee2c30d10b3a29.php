                ...
                <div class="col-lg-3 col-md-12">
                    <div class="woocommerce-widget-area">
                        ...
                        <div class="woocommerce-widget collections-list-widget">
                            <h3 class="woocommerce-widget-title">Brand</h3>

                            <ul class="collections-list-row">
                                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="/brand/<?php echo e($brand->slug); ?>"
                                            class="<?php echo e($brand->slug == $brandSlug->slug ? 'active' : ''); ?>">
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\omcnew project\OMCNEW\resources\views/frontend/brand-items.blade.php ENDPATH**/ ?>