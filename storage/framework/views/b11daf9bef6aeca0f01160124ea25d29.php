        ...
        <div class="container py-4 px-4">
            ...
            <div class="card-container px-4">
                <div class="card py-3 px-5">
                    <div class="card-body">
                        <form action="<?php echo e(route('insert_or_update_logo')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="logoName" name="title"
                                    value="<?php echo e(old('title', $logo->title)); ?>" placeholder="Enter logo title">
                            </div>
                            ...
                            <div class="mb-3 responsive-logo-wrapper">
                                ...
                                <?php if($logo->image_path): ?>
                                    <div>
                                        <img src="<?php echo e(asset('storage/logo_images/' . $logo->image_path)); ?>" alt="Logo Image"
...
<?php echo $__env->make('layouts.admin_main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\omcnew project\OMCNEW\resources\views/admin_dashboard/logo.blade.php ENDPATH**/ ?>