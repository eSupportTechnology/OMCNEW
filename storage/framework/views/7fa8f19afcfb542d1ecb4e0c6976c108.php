                        ...
                        <div class="row gx-5">
                            ...
                            <main class="col-lg-7">
                                ...
                                <div class="product-container">
                                    ...
                                    <!-- Color Options -->
                                    <?php
    $hex = str_starts_with($color->hex_value, '#') ? $color->hex_value : '#'.$color->hex_value;
?>

<button class="btn btn-outline-secondary btn-sm color-option"
    style="background-color: <?php echo e($hex); ?>; border-color: #e8ebec; height: 17px; width: 15px;"
    data-color="<?php echo e($hex); ?>"
