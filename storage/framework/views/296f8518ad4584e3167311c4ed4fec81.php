...
<div class="container">
    ...
    <div class="products-container">
        <?php if($orderedProducts->isEmpty()): ?>
        <div style="text-align: center; padding: 40px 0; font-size: 1rem; color: var(--text-light);">
        ...
        <div class="owl-carousel special-offer-slider owl-theme">
            ...
            <div class="product-card">
                ...
                <div class="discount-badge">
                    <?php echo e(round((($product->normal_price - $sale->sale_price) / $product->normal_price) * 100)); ?>%
                </div>
                <?php endif; ?>
                ...
                <div class="product-info">
                    <h4 class="product-name"><?php echo e($product->product_name); ?></h4>
                    <div class="product-price">
                        <span class="price-crossed">Rs.<?php echo e(number_format($sale->normal_price, 0)); ?></span>
                        Rs.<?php echo e(number_format($sale->sale_price, 0)); ?>
...
<?php echo $__env->make('frontend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OMCNEW\resources\views/frontend/home.blade.php ENDPATH**/ ?>