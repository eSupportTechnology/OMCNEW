...
<div class="container mx-auto px-4 py-8">
    <!-- Alert Message -->
    <div id="successAlert" class="hidden bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-6">
                    ...
                    <div class="mb-6">
                        <ul class="flex flex-wrap gap-4" id="paymentTabs">
                            <li class="flex-1 min-w-[140px]">
                                <button id="creditCardTab" class="w-full bg-blue-50 border border-blue-600 text-blue-600 p-4 rounded flex flex-col items-center justify-center transition-all hover:shadow-md active">
                            ...
                            <li class="flex-1 min-w-[140px]">
                                <button id="codTab" class="w-full bg-white border border-gray-300 text-gray-600 p-4 rounded flex flex-col items-center justify-center transition-all hover:shadow-md hover:bg-gray-50">
                    ...
                    <div class="bg-white rounded p-4 md:p-6 border border-gray-200">
                        ...
                        <div id="creditCardContent" class="w-full md:w-2/3">
                            <form id="cardPaymentForm">
                                ...
                                <div class="mt-6">
                                    <button type="submit" class="w-full bg-blue-600 text-white py-3 px-4 rounded font-medium hover:bg-blue-700 transition-colors">
                                        Complete Payment
                                    </button>
                                </div>
                            </form>
                        ...
                        <div id="codContent" class="hidden">
                            <div class="bg-blue-50 border border-blue-100 p-4 rounded mb-6">
                                ...
                                <ul class="pl-5 space-y-2">
                                    ...
                                    <li class="text-gray-600">Check your delivery status is updated to 'Out for Delivery' before accepting</li>
                                    <li class="text-gray-600">Keep the exact amount ready to ensure smooth delivery</li>
                                </ul>
                            </div>
                            <form id="codForm">
                                <button type="submit" class="bg-blue-600 text-white py-3 px-6 rounded font-medium hover:bg-blue-700 transition-colors">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t border-gray-200 pt-4 mb-6">
                        <div class="flex justify-between font-semibold">
                            ...
                            <span class="text-gray-800">Rs. <?php echo e(number_format($total, 2)); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded">
                        ...
                        <p class="text-sm text-gray-600">Your payment information is processed securely. We do not store credit card details.</p>
                    </div>
                </div>
            </div>
        </div>
