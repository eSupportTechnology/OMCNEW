<?php $__env->startSection('dashboard-content'); ?>
    ...
    <div class="min-h-screen bg-gray-50 p-4 md:p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 md:p-6 flex items-center mb-6">
            <?php if(isset($user)): ?>
                <img src="<?php echo e($user->profile_image_url); ?>" alt="Profile Picture"
                    class="w-16 h-16 md:w-20 md:h-20 rounded-full object-cover mr-4 md:mr-6 border-2 border-blue-100">
                <div>
                    <h2 class="text-xl md:text-2xl font-bold text-gray-800"><?php echo e($user->name); ?></h2>
                    <p class="text-gray-500 text-sm md:text-base">Member since <?php echo e($user->created_at->format('M Y')); ?></p>
                </div>
            <?php else: ?>
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 md:p-6 mb-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <a href="<?php echo e(route('myreviews')); ?>"
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-4 md:p-6 flex-1">
                <h3 class="text-lg md:text-xl font-semibold text-blue-600 border-b border-blue-100 pb-3 mb-4">Recent
                    Activities</h3>
                <ul class="space-y-3">
                        ...
                        <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="p-3 hover:bg-gray-50 rounded-lg transition">
                                <div class="flex items-start">
                                    ...
                                    <div class="text-sm md:text-base text-gray-700"><?php echo $activity; ?></div>
                                </div>
                            </li>
            ...
            <div class="bg-white rounded-xl shadow-sm p-4 md:p-6 flex-1">
                <h3 class="text-lg md:text-xl font-semibold text-blue-600 border-b border-blue-100 pb-3 mb-4">Notifications
                </h3>
                <ul class="space-y-3">
                        ...
                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="p-3 hover:bg-gray-50 rounded-lg transition">
                                <div class="flex items-start">
                                    ...
                                    <div class="text-sm md:text-base text-gray-700"><?php echo $notification; ?></div>
                                </div>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 md:p-6 mt-6 max-w-4xl mx-auto">
            <h3 class="text-lg md:text-xl font-semibold text-blue-600 border-b border-blue-100 pb-3 mb-4">Frequently Asked
                Questions</h3>
            <div class="space-y-2">
                <div class="faq-item border rounded-lg overflow-hidden">
                    <button
                        class="faq-question w-full flex justify-between items-center p-4 text-left bg-white hover:bg-gray-50 transition">
                        <span>How do I track my order?</span>
                        <svg class="w-5 h-5 text-gray-500 transform transition-transform" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div class="faq-answer p-4 bg-gray-50 hidden">
                        <p>You can track your order by visiting the "My Orders" section in your dashboard. Once your order
                            is shipped, you'll receive a tracking number.</p>
                    </div>
                </div>
...
<?php echo $__env->make('member_dashboard.user_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\omcnew project\OMCNEW\resources\views/member_dashboard/dashboard.blade.php ENDPATH**/ ?>