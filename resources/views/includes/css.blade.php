...
<link href="{{ asset('assets/plugins/themify/themify-icons.css') }}" rel="stylesheet">
<link href="{{ asset('assets/plugins/fontawesome/css/all.min.css') }}" rel="stylesheet">
<link href="{{ asset('assets/plugins/owl-carousel/dist/assets/owl.carousel.min.css') }}" rel="stylesheet">
...
<link href="{{ asset('assets/plugins/select2/dist/css/select2-bootstrap.min.css') }}" rel="stylesheet">
<link href="{{ asset('assets/plugins/daterangepicker/daterangepicker.css') }}" rel="stylesheet">
<link href="{{ asset('assets/plugins/fancybox/dist/jquery.fancybox.min.css') }}" rel="stylesheet">
...
<link href="{{ asset('assets/plugins/main_style.css') }}" rel="stylesheet">
