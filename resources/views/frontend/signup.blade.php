                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" required pattern="[A-Za-z\s]+" value="{{ old('name') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                                name="address" required value="{{ old('address') }}" placeholder="Enter your address">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('district') is-invalid @enderror" id="district"
                                name="district" required style="height:48px;border:1px solid #b9b8b8">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('DOB') is-invalid @enderror" id="DOB"
                                name="DOB" required value="{{ old('DOB') }}" max="{{ $today }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tel" class="form-control @error('phone_num') is-invalid @enderror"
                                id="phone_num" name="phone_num" required pattern="^0\d{9}$" value="{{ old('phone_num') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" required value="{{ old('email') }}" placeholder="Enter your email"
