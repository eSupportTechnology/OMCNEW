        ...
        <div class="owl-carousel special-offer-slider owl-theme">
            ...
            <div class="product-card">
                ...
                <div class="discount-badge">
                    {{ round((($product->normal_price - $sale->sale_price) / $product->normal_price) * 100) }}%
                </div>
                @endif
                ...
                <div class="product-info">
                    <h4 class="product-name">{{ $product->product_name }}</h4>
                    <div class="product-price">
                        <span class="price-crossed">Rs.{{ number_format($sale->normal_price, 0) }}</span>
                        Rs.{{ number_format($sale->sale_price, 0) }}
                    </div>
                </div>
                @endif
            </div>
