        ...
        <div class="row">
            <div class="d-flex justify-content-center about-img-set gap-3">
                <div class="about-box text-right" style="width: 382px; height: 383px;">
                    <img class="img-fluid w-100 h-100 object-fit-cover" src="{{ asset('themes/buyabans/assets/images/diverse-sectors.webp') }}" alt="Expertise">
                </div>
                <div class="about-box text-center" style="width: 382px; height: 383px;">
                    <img class="img-fluid w-100 h-100 object-fit-cover" src="{{ asset('themes/buyabans/assets/images/31.webp') }}" alt="Projects">
                </div>
                <div class="about-box text-left" style="width: 382px; height: 383px;">
                    <img class="img-fluid w-100 h-100 object-fit-cover" src="{{ asset('themes/buyabans/assets/images/32.webp') }}" alt="Services">
                </div>
            </div>
