                    ...
                    <div class="slick-thumbs">
                        <ul>
                            @foreach($product->images as $image)
                                <li>
                                    <a href="javascript:void(0)" class="thumbnail-link" data-src="{{ asset('storage/' . $image->image_path) }}">
                                        <img 
                ...
                <div class="products-details-desc">
                    ...
                    <ul class="products-info">
                        ...
                        <li>
                            ...
                            <span class="product-description">{{ Str::limit(strip_tags($product->product_description), 150) }}</span>
                        </li>
                    </ul>
                        ...
                        <div class="products-size-wrapper">
                            ...
                            <ul>
                                @foreach($product->variations->where('type', 'Size') as $size)
                                    @if($size->quantity > 0)
                                        <li>
                                            <a href="javascript:void(0)" class="size-option" data-size="{{ $size->value }}">
                                                {{ $size->value }}
                                            </a>
                                        </li>
                                    @endif
                    ...
                    <div class="products-add-to-cart">
                        <div class="input-counter">
                            ...
                            <input type="text" id="quantity" value="1" min="1" max="{{ $product->quantity }}">
                        ...
                        <a href="javascript:void(0)" class="wishlist-toggle" data-product-id="{{ $product->product_id }}" id="wishlist-{{ $product->product_id }}">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            @foreach($product->variations->where('type', 'Color') as $color)
                                                @if($color->quantity > 0)
                                                    <span style="background-color: {{ $color->hex_value }}; width: 20px; height: 20px; display: inline-block; border-radius: 50%; margin-right: 5px;" title="{{ $color->value }}"></span>
                                                @endif
                                            @endforeach
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            @foreach($product->variations->where('type', 'Size') as $size)
                                                @if($size->quantity > 0)
                                                    <span class="badge bg-light text-dark me-1">{{ $size->value }}</span>
                                                @endif
                                            @endforeach
                                        </td>
                                    </tr>
                                            ...
                                            <div class="review-media">
                                                @foreach ($review->media as $media)
                                                    @if ($media->media_type === 'image')
                                                        <a href="{{ asset('storage/' . $media->media_path) }}" class="glightbox">
                                                            <img src="{{ asset('storage/' . $media->media_path) }}" alt="Review Media" class="review-image">
                                                        </a>
