...
<div class="d-flex justify-content-between align-items-center mt-4">
    <div class="button-tabs">
        ...
        <button class="tab-button" data-target="confirmed-orders">Confirmed</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ✅ Auto-switch tab using ?tab= parameter
        const urlParams = new URLSearchParams(window.location.search);
        const tabParam = urlParams.get('tab');

        if (tabParam) {
            const targetButton = document.querySelector(`.tab-button[data-target="${tabParam}-orders"]`);
            const targetContent = document.getElementById(`${tabParam}-orders`);
            if (targetButton && targetContent) {
                ...
                // Optional: smooth scroll to the orders section
