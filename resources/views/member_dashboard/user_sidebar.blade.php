            ...
            <div class="col-lg-3 col-md-4" id="dashboardSidebar">
                <div class="dashboard-sidebar">
                    <ul class="nav flex-column dashboard-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('myorders') ? 'active' : '' }}"
                                href="{{ route('myorders') }}">My Orders</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('myreviews') ? 'active' : '' }}"
                                href="{{ route('myreviews') }}">My Reviews</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('myinquiries') ? 'active' : '' }}"
                                href="{{ route('myinquiries') }}">Inquiries</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('addresses') ? 'active' : '' }}"
                                href="{{ route('addresses') }}">Address Book</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('change-password') ? 'active' : '' }}"
                                href="{{ route('change-password') }}">Password</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('returns') ? 'active' : '' }}"
                                href="{{ route('returns') }}">Returns</a>
                        </li>
                        <li class="nav-item">
